...
from Compute_IOU import my_iou_metric

class U_net:


    def u_net_model(X_train, Y_train,batch_size=16,epochs=50,validation_split=0.1,IMG_WIDTH = 256,IMG_HEIGHT = 256,IMG_CHANNELS = 3):
